...
export default class ConfAccountHealthMetric extends LightningElement {
    ...
    //                 // console.log('this.accntMetricData :  '+JSON.stringify(this.accntMetricData));
    ...
    handleSubmit(e){
        ...
        getColumnName({'categId':this.accntTypeId})
                        .then(result=>{
                            ...
                            //console.log('fields :  '+JSON.stringify(fields)+'   Column Name :  '+this.columnName);
    ...
    handleSuccess(event){
        ...
        //     fields.varasi_am__Column_Name__c = result;
        //     alert(JSON.stringify(fields));
        // })
