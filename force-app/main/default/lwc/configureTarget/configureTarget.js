...
export default class ConfigureTarget extends LightningElement {
     ...
     wireTreeData(result) {
        ...
        if (result.data) {
             ...
             for(var cType in this.treeItems){
                if(this.treeItems[cType].name=='Target'){
    ...
    //                     this.targetMetricData = this.treeItems[cType]._children[i]._children;
    //                     // console.log('this.targetMetricData :  '+JSON.stringify(this.targetMetricData));
    //                     if(this.targetMetricData.length>=5){
    ...
    deleteMetric(e){
        //console.log("DElete"+e.target.dataset.label);
